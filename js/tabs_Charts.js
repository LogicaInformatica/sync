	...
	initComponent : function() {
		...
		if (this.task=="GEO")
		{
			fields = [{name: 'Area'},
		              ...
		              {name: 'CSSI8'},{name: 'CSSI8Num',type:'int'},
...
//		              {name: 'Sting'},{name: 'StingNum',type:'int'}
		 	...
		 	columns = [{dataIndex:'Area',width:87, header:'Regione',sortable:false},
		   	           ...
		   	           {dataIndex:'CSSI8',width:100, header:'CSS (I8)<br>IPR',sortable:true,align:'right',css:'background-color:lavender;',renderer:DCS.render.floatV},
		   	           {dataIndex:'CSSI8Num',width:50, header:'N.',sortable:true,align:'right',renderer:DCS.render.intV},
		   	           {dataIndex:'Css',width:100, header:'CSS (45)<br>IPR',sortable:true,align:'right',css:'background-color:lavender;',renderer:DCS.render.floatV},
