...
standardSubmit: true,
        ...
        items:[{ 
            ...
            {	xtype:'checkboxgroup',
    		    id:'CPGroup',
    		    fieldLabel: 'Mandatari',
    		    itemCls: 'x-check-group-alt',
    		    columns: 1,
    		    items: [
    		            {style: 'padding-left:0px; anchor:"0%";',xtype: 'checkbox',boxLabel: 'Tutti i mandatari'},
    		            {style: 'padding-left:0px; anchor:"0%";',xtype: 'checkbox',boxLabel: 'Toyota FS'},
    		            {style: 'padding-left:0px; anchor:"0%";',xtype: 'checkbox',boxLabel: 'Committente 2'},
    		            {style: 'padding-left:0px; anchor:"0%";',xtype: 'checkbox',boxLabel: 'Committente 3'}
    		            ]
    		}      
            ],
            keys: {	
