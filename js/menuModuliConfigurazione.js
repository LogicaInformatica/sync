...
------------------------------------------------------------------*/
		...
		setButton(tabrow4,1,'Causali movimento',	DCS.TipoMovimento.create,		CONTEXT.MENU_ANA_CMOV);
		setButton(tabrow5,1,'Famiglie di prodotti',	DCS.FamigliaProdotto.create,	CONTEXT.MENU_ANA_FMP);
		setButton(tabrow6,1,'Modelli',				DCS.Modelli.create,				CONTEXT.MENU_CONF_MOD);
		setButton(tabrow7,1,'Nazioni',				DCS.NazioniDec.create,			CONTEXT.MENU_CONF_NAZ);
		setButton(tabrow8,1,'Prodotti',				DCS.Prodotto.create,			CONTEXT.MENU_ANA_PRO);
		setButton(tabrow9,1,'Province',				DCS.ProvinceDec.create,			CONTEXT.MENU_CONF_PROV);
		...
		setButton(tabrow8,2,'Stati stragiudiziali',	DCS.StatoStragiudizialeConf.create,	CONTEXT.MENU_GP_SSTG);
		setButton(tabrow9,2,'Tipi di allegato',		DCS.TipoAllegato.create,		CONTEXT.MENU_CONF_TALL);
		...
		setButton(tabrow4,3,'Tipi di incasso',		DCS.TIncassoConf.create,		CONTEXT.MENU_CONF_TINC);
		setButton(tabrow5,3,'Tipi di insoluto',		DCS.TipoInsoluto.create,		CONTEXT.MENU_CONF_TINS);
		setButton(tabrow6,3,'Tipi di pagamento',	DCS.TipoPagamento.create,		CONTEXT.MENU_CONF_TPAG);
		setButton(tabrow7,3,'Tipi di partita',		DCS.TipoPartita.create,			CONTEXT.MENU_CONF_TPAR);
		setButton(tabrow8,3,'Tipi di richiesta',	DCS.TRichiestaConf.create,		CONTEXT.MENU_CONF_TRIC);
