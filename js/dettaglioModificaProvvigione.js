...
DCS.DettaglioModifica = Ext.extend(Ext.TabPanel, {
	   ...
	   initComponent: function() {
			...
			var elimina = new Ext.Button(
					{
						...
						handler: function(b,event)
						{
					    	Ext.Msg.confirm('Conferma', "Si desidera eliminare questa modifica al calcolo provvigioni ?",
					    			...
					    			},this); // l'ultimo parametro � lo scope, che viene passato a callServer
						},scope:this
					});
			...
			// Campi di input
//			
//			// Data del lotto (combobox che mostra solo le date che � possibile impostare)
...
//											Ext.getCmp("DataLottoMod").setValue('');
										...
										else // non pi� cancellazione rata: rimette i valori di default
										{
		  ...
		  dsStoreModifica.load({
				...
				callback: function(r, options, success){
					if (success && r.length > 0) {
						...
						Ext.getCmp('FlagCancellazione').setValue(r[0].json.TipoCorrezione=='D'); // � una cancellazione
						...
						{
							Ext.getCmp('btnElimina').setDisabled(true); // se � una nuova correzione, disabilita il bottone "elimina"
