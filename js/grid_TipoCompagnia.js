try
{
	var tableTipoCompagnia = new DCS.Table();
	tableTipoCompagnia.name = "tipocompagnia";
	tableTipoCompagnia.pk = "IdTipoCompagnia";
	tableTipoCompagnia.expandCol = "titolo";

	//------------------------- Record -------------------------
	tableTipoCompagnia.record = Ext.data.Record.create([
		{name: 'IdTipoCompagnia', type: 'int', allowBlank:false},
		{name: 'CodTipoCompagnia', allowBlank:false},		// Codice abbreviato dello stato
		{name: 'TitoloTipoCompagnia', allowBlank:false},
	...
	//------------------------- ColumnModel -------------------------
	tableTipoCompagnia.colModel = new Ext.grid.ColumnModel({
	...
	tableTipoCompagnia.newRecord = function() {
		return new tableTipoCompagnia.record({	//specify default values
			IdTipoCompagnia: 0,
			CodTipoCompagnia: '', 
			TitoloTipoCompagnia: '',
			Ordine:1,
	...
	//--------------------------------
	var fn_anagTipoCompagnia= function() {
		var gridTipoCompagnia = new EditGrid(tableTipoCompagnia);
	
		return gridTipoCompagnia.getGrid();
	};
}
catch (e)
{
	alert("grid_TipoCompagnia.js: " + e);
}
