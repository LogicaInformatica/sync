...
else
{
	...
	// Determina se � una richiesta o proposta e se � normale o differito
...
if ($context["InternoEsterno"]=="E") // se utente di agenzia, non pu� mettere scadenze oltre il periodo di affido
{
...
var formPanel = new Ext.form.FormPanel({
    ...
    autoHeight: true,
        ...
        items: [
            // la struttura � fatta di righe isolate, perch� se si usa uno solo layout column
