        		...
        		items:[
        		{
		         ...
		         items:[{  
				   ...
				   {   
					...
					defaults: {anchor:'98%', style: 'text-align:left'},
					items: [{
			        	xtype: 'displayfield',
					    fieldLabel: 'Tot. Debiti residui',
		                value: "<?php echo $totCapitale?>",
		                //name: 'totDebResiduo',
		                id: 'totDebResiduo',
				   ...
				   {   
				    xtype:'panel', layout:'form', labelWidth:125, defaultType:'textfield', columnWidth: .40,
					defaults: {anchor:'98%', style: 'text-align: left'},
					items: [{
			        	xtype: 'displayfield',
					    fieldLabel: 'Tot. Importi proposti',
		                value: "<?php echo $totImportoProposto?>",
		                //name: 'totImpProposti',
		                id: 'totImpProposti',
		                style: 'fontWeight:bold'
                    }]
