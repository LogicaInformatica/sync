CREATE OR REPLACE ALGORITHM=MERGE VIEW v_insoluti_str
AS
select
...
ImpInsoluto+ImpDebitoResiduo AS ImpDebitoResiduo,ImpPagato,sc.CodStatoRecupero AS stato,sc.AbbrStatoRecupero,
...
IFNULL(cl.FlagRecupero,'N') AS InRecupero,NumInsoluti,NumRate,FasciaRecupero,td.FormDettaglio
from contratto co
