...
and DATEDIFF(CURDATE(), DataRata) NOT BETWEEN CASE WHEN CodRegolaProvvigione IN ('I1','I7','P2','P4') THEN 0
   #      WHEN CodRegolaProvvigione IN ('P2','P4') THEN 31
         WHEN CodRegolaProvvigione IN ('20','06','29') THEN 31
         WHEN CodRegolaProvvigione IN ('S2','28') THEN 61
         WHEN CodRegolaProvvigione = '24' THEN 91
         WHEN CodRegolaProvvigione IN ('L2','L3') THEN 61
         WHEN CodRegolaProvvigione = '27' THEN 151
         WHEN CodRegolaProvvigione = 'F1' THEN 31
         WHEN CodRegolaProvvigione = 'F2' THEN 91
         ELSE 0 END
AND
CASE WHEN CodRegolaProvvigione IN ('I1','I7','P2','P4') THEN 30
  #       WHEN CodRegolaProvvigione IN ('P2','P4') THEN 60
         WHEN CodRegolaProvvigione IN ('20','06','29') THEN 60
         WHEN CodRegolaProvvigione IN ('S2','28') THEN 90
