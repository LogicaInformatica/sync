...
v.InRecupero,NumInsoluti,NumRate,FasciaRecupero,v.FormDettaglio,StatoLegale,co.IdStatoLegale,StatoStragiudiziale, co.IdStatoStragiudiziale, Garanzie, co.FlagVisuraAci
from contratto co
