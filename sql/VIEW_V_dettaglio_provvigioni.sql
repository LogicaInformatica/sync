...
JOIN contratto c ON c.IdContratto=d.IdContratto
...
LEFT JOIN v_sintesi_modificaprovvigione mp ON mp.IdContratto=d.IdContratto AND mp.DataFineAffido=d.DataFineAffido
;
