...
#
# nel caso dello stragiudiziale, la chiusura provvigioni � mensile, quindi visualizza tutti i lotti in corso come
...
# (cio� sono usate per la lista visibile alle agenzie)
#
