...
Ext.ux.menu.EditableItem = Ext.extend(Ext.menu.BaseItem, {
    ...
    onRender: function(container){
        var s = container.createChild({
        	cls: this.itemCls,
        	html: '<img src="' + this.iconXX+ '" style="margin: 3px 10px 2px 2px;" />'});
        //riga cancellata - html: '<img src="' + (this.icon||Ext.BLANK_IMAGE_URL)+ '" class="x-menu-item-icon'+(this.iconCls?' '+this.iconCls:'')+'" style="margin: 3px 7px 2px 2px;" />'});
